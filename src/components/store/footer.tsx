      ...
      <div className="container-nx grid gap-10 py-14 md:grid-cols-4">
        ...
        <div>
          ...
          <div className="mt-3 flex flex-col gap-2 text-sm">
            ...
            <a href={site.support.telegramPrimary} target="_blank" rel="noreferrer">Telegram</a>
            <a href={site.support.telegramSecondary} target="_blank" rel="noreferrer">Telegram 2</a>
          </div>
        </div>
        <div>
          ...
          <div className="mt-3 flex flex-col gap-2 text-sm">
            <a href={site.social.telegramChannel} target="_blank" rel="noreferrer">Telegram</a>
            <a href={site.social.playerokReviews} target="_blank" rel="noreferrer">{t.reviews_playerok}</a>
          </div>
        </div>
      </div>
